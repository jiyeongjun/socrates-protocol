...
The current release tag is `v0.6.2`.
The current package version in this worktree is `0.6.2`.
...
- run `npm run verify:release-assets -- --ref v0.6.2` to confirm every installer asset exists in that release ref
