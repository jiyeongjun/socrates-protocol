...
- Ask only about decisions that change code, behavior, or verification.
...
- For low-risk local work, if a public-behavior-preserving default is obvious, state the assumption in one sentence and proceed.
